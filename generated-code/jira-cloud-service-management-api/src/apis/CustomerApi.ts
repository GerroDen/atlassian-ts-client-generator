...
export interface RevokePortalOnlyAccessForUserRequest {
    accountId: string;
}
...
export class CustomerApi extends runtime.BaseAPI {
    ...
    async revokePortalOnlyAccessForUserRaw(requestParameters: RevokePortalOnlyAccessForUserRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<any>> {
        if (requestParameters['accountId'] == null) {
            throw new runtime.RequiredError(
                'accountId',
                'Required parameter "accountId" was null or undefined when calling revokePortalOnlyAccessForUser().'
            );
        }
     ...
     * Revoke portal only access for user
     */
    async revokePortalOnlyAccessForUser(requestParameters: RevokePortalOnlyAccessForUserRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<any> {
        const response = await this.revokePortalOnlyAccessForUserRaw(requestParameters, initOverrides);
        return await response.value();
    }
