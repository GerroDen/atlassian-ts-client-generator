...
export class FeatureFlagsApi extends runtime.BaseAPI {
    ...
    /**
     * Creates request options for deleteFeatureFlagById without sending the request
     */
    async deleteFeatureFlagByIdRequestOpts(requestParameters: DeleteFeatureFlagByIdRequest): Promise<runtime.RequestOpts> {
    ...
    async deleteFeatureFlagByIdRaw(requestParameters: DeleteFeatureFlagByIdRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        const requestOptions = await this.deleteFeatureFlagByIdRequestOpts(requestParameters);
    ...
    /**
     * Creates request options for deleteFeatureFlagsByProperty without sending the request
     */
    async deleteFeatureFlagsByPropertyRequestOpts(requestParameters: DeleteFeatureFlagsByPropertyRequest): Promise<runtime.RequestOpts> {
        if (requestParameters['authorization'] == null) {
            throw new runtime.RequiredError(
                'authorization',
    ...
    async deleteFeatureFlagsByPropertyRaw(requestParameters: DeleteFeatureFlagsByPropertyRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        const requestOptions = await this.deleteFeatureFlagsByPropertyRequestOpts(requestParameters);
        const response = await this.request(requestOptions, initOverrides);
    ...
    /**
     * Creates request options for getFeatureFlagById without sending the request
     */
    async getFeatureFlagByIdRequestOpts(requestParameters: GetFeatureFlagByIdRequest): Promise<runtime.RequestOpts> {
        if (requestParameters['authorization'] == null) {
            throw new runtime.RequiredError(
                'authorization',
    ...
    async getFeatureFlagByIdRaw(requestParameters: GetFeatureFlagByIdRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<FeatureFlagData>> {
        const requestOptions = await this.getFeatureFlagByIdRequestOpts(requestParameters);
        const response = await this.request(requestOptions, initOverrides);
    ...
    /**
     * Creates request options for submitFeatureFlags without sending the request
     */
    async submitFeatureFlagsRequestOpts(requestParameters: SubmitFeatureFlagsRequest): Promise<runtime.RequestOpts> {
        if (requestParameters['authorization'] == null) {
            throw new runtime.RequiredError(
                'authorization',
    ...
    async submitFeatureFlagsRaw(requestParameters: SubmitFeatureFlagsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<SubmitFeatureFlagsResponse>> {
        const requestOptions = await this.submitFeatureFlagsRequestOpts(requestParameters);
        const response = await this.request(requestOptions, initOverrides);
