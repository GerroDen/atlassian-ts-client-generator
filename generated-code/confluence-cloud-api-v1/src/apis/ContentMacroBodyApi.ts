...
export class ContentMacroBodyApi extends runtime.BaseAPI {
    ...
    /**
     * Creates request options for getAndAsyncConvertMacroBodyByMacroId without sending the request
     */
    async getAndAsyncConvertMacroBodyByMacroIdRequestOpts(requestParameters: GetAndAsyncConvertMacroBodyByMacroIdRequest): Promise<runtime.RequestOpts> {
    ...
    async getAndAsyncConvertMacroBodyByMacroIdRaw(requestParameters: GetAndAsyncConvertMacroBodyByMacroIdRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<AsyncId>> {
        const requestOptions = await this.getAndAsyncConvertMacroBodyByMacroIdRequestOpts(requestParameters);
    ...
    /**
     * Creates request options for getAndConvertMacroBodyByMacroId without sending the request
     */
    async getAndConvertMacroBodyByMacroIdRequestOpts(requestParameters: GetAndConvertMacroBodyByMacroIdRequest): Promise<runtime.RequestOpts> {
        if (requestParameters['id'] == null) {
            throw new runtime.RequiredError(
                'id',
    ...
    async getAndConvertMacroBodyByMacroIdRaw(requestParameters: GetAndConvertMacroBodyByMacroIdRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ContentBody>> {
        const requestOptions = await this.getAndConvertMacroBodyByMacroIdRequestOpts(requestParameters);
        const response = await this.request(requestOptions, initOverrides);
    ...
    /**
     * Creates request options for getMacroBodyByMacroId without sending the request
     */
    async getMacroBodyByMacroIdRequestOpts(requestParameters: GetMacroBodyByMacroIdRequest): Promise<runtime.RequestOpts> {
        if (requestParameters['id'] == null) {
            throw new runtime.RequiredError(
                'id',
    ...
    async getMacroBodyByMacroIdRaw(requestParameters: GetMacroBodyByMacroIdRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<MacroInstance>> {
        const requestOptions = await this.getMacroBodyByMacroIdRequestOpts(requestParameters);
        const response = await this.request(requestOptions, initOverrides);
