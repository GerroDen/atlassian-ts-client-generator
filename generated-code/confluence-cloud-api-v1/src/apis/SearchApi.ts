...
export class SearchApi extends runtime.BaseAPI {
    ...
    /**
     * Searches for users using user-specific queries from the [Confluence Query Language (CQL)](https://developer.atlassian.com/cloud/confluence/advanced-searching-using-cql/).  Note that some user fields may be set to null depending on the user\'s privacy settings. These are: email, profilePicture, displayName, and timeZone.
     * Search users
     */
