...
`buildDefinition` | [BuildDefinition](BuildDefinition.md)
`buildDefinitionXml` | [BuildDefinitionForBuild](BuildDefinitionForBuild.md)
`buildKey` | string
`buildLogger` | [BuildLogger](BuildLogger.md)
`buildName` | string
`busy` | boolean
...
`latestResultsSummary` | [ResultsSummary](ResultsSummary.md)
`markedForDeletion` | boolean
`master` | [ImmutablePlan](ImmutablePlan.md)
`masterId` | number
