...
export interface GetConfiguration1Request {
    configurationId: number;
}
...
export interface UpdateServerLocalArtifactHandlerRequest {
    simpleRestArtifactHandler: SimpleRestArtifactHandler;
}
...
export class DefaultApi extends runtime.BaseAPI {
    ...
    /**
     * Enables access (i.e. allowing modifications) for all Bamboo linked repositories by the Bamboo Specs code stored in this repository.
     */
     ...
     */
    async getBambooServerLocalArtifactHandlerRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<SimpleRestArtifactHandler>> {
        const queryParameters: any = {};

        const headerParameters: runtime.HTTPHeaders = {};

        const response = await this.request({
            path: `/admin/latest/artifactHandlers/serverLocal`,
            method: 'GET',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);
     ...
     * Retrieve configuration of Server-Local Artifact Handler.
     */
    async getBambooServerLocalArtifactHandler(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<SimpleRestArtifactHandler> {
        const response = await this.getBambooServerLocalArtifactHandlerRaw(initOverrides);
        return await response.value();
    }
     ...
     */
    async getConfigurationRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<RestCombinedExpiryConfiguration>> {
        const queryParameters: any = {};
     ...
     * Retrieves global build and deployment expiry configuration for this Bamboo instance.
     */
    async getConfiguration(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<RestCombinedExpiryConfiguration> {
     ...
     */
    async getConfiguration1Raw(requestParameters: GetConfiguration1Request, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<RestElasticImageConfig>> {
        if (requestParameters.configurationId === null || requestParameters.configurationId === undefined) {
            throw new runtime.RequiredError('configurationId','Required parameter requestParameters.configurationId was null or undefined when calling getConfiguration1.');
        }
     ...
     * Elastic image configuration details.
     */
    async getConfiguration1(requestParameters: GetConfiguration1Request, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<RestElasticImageConfig> {
        const response = await this.getConfiguration1Raw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     */
    async testConnectionRaw(requestParameters: TestConnectionRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<RestRepositoryConnectionResult>> {
        const queryParameters: any = {};
     ...
     * Tests connection to a repository if the repository type supports connection testing. Request payload should contain repository configuration.
     */
    async testConnection(requestParameters: TestConnectionRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<RestRepositoryConnectionResult> {
     ...
     */
    async updateServerLocalArtifactHandlerRaw(requestParameters: UpdateServerLocalArtifactHandlerRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<RestArtifactHandler>> {
        if (requestParameters.simpleRestArtifactHandler === null || requestParameters.simpleRestArtifactHandler === undefined) {
            throw new runtime.RequiredError('simpleRestArtifactHandler','Required parameter requestParameters.simpleRestArtifactHandler was null or undefined when calling updateServerLocalArtifactHandler.');
        }
     ...
     * Update Server-Local Artifact handler configuration.
     */
    async updateServerLocalArtifactHandler(requestParameters: UpdateServerLocalArtifactHandlerRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<RestArtifactHandler> {
        const response = await this.updateServerLocalArtifactHandlerRaw(requestParameters, initOverrides);
        return await response.value();
    }
