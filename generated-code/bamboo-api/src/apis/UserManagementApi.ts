...
export class UserManagementApi extends runtime.BaseAPI {
     ...
     */
    async findAssignedGroupsRaw(requestParameters: FindAssignedGroupsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<FindAssignedGroups200Response>> {
        if (requestParameters.name === null || requestParameters.name === undefined) {
     ...
     * Retrieves a list of groups to which the user belongs. The authenticated user must have restricted administrative permission or higher to use this resource.
     */
    async findAssignedGroups(requestParameters: FindAssignedGroupsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<FindAssignedGroups200Response> {
     ...
     */
    async findUnassignedGroupsRaw(requestParameters: FindUnassignedGroupsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<FindAssignedGroups200Response>> {
        if (requestParameters.name === null || requestParameters.name === undefined) {
     ...
     * Retrieves a list of groups to which the user does not belong. The authenticated user must have restricted administrative permission or higher to use this resource.
     */
    async findUnassignedGroups(requestParameters: FindUnassignedGroupsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<FindAssignedGroups200Response> {
     ...
     */
    async findUnassignedUserRepositoryAliasesRaw(requestParameters: FindUnassignedUserRepositoryAliasesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<FindUnassignedUserRepositoryAliases200Response>> {
        if (requestParameters.name === null || requestParameters.name === undefined) {
     ...
     * Retrieves a list of unlinked aliases to which the user does not belong. The authenticated user must have restricted administrative permission or higher to use this resource.
     */
    async findUnassignedUserRepositoryAliases(requestParameters: FindUnassignedUserRepositoryAliasesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<FindUnassignedUserRepositoryAliases200Response> {
     ...
     */
    async findUsersInGroupRaw(requestParameters: FindUsersInGroupRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<GetUsers200Response>> {
        if (requestParameters.name === null || requestParameters.name === undefined) {
     ...
     * Retrieves a list of users that are members of a specified group. The authenticated user must have restricted administrative permission or higher to use this resource.
     */
    async findUsersInGroup(requestParameters: FindUsersInGroupRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<GetUsers200Response> {
     ...
     */
    async findUsersNotInGroupRaw(requestParameters: FindUsersNotInGroupRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<GetUsers200Response>> {
        if (requestParameters.name === null || requestParameters.name === undefined) {
     ...
     * Retrieves a list of users that are not members of a specified group. The authenticated user must have restricted administrative permission or higher to use this resource.
     */
    async findUsersNotInGroup(requestParameters: FindUsersNotInGroupRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<GetUsers200Response> {
     ...
     */
    async getGroupsRaw(requestParameters: GetGroupsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<FindAssignedGroups200Response>> {
        const queryParameters: any = {};
     ...
     * Retrieve a paginated list of groups. The authenticated user must have restricted administrative permission or higher to use this resource.
     */
    async getGroups(requestParameters: GetGroupsRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<FindAssignedGroups200Response> {
     ...
     */
    async getUserAccessTokensRaw(requestParameters: GetUserAccessTokensRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<GetUserAccessTokens200Response>> {
        if (requestParameters.name === null || requestParameters.name === undefined) {
     ...
     * Retrieve a page of user\'s access tokens. The authenticated user must have restricted administrative permission or higher to use this resource.
     */
    async getUserAccessTokens(requestParameters: GetUserAccessTokensRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<GetUserAccessTokens200Response> {
     ...
     */
    async getUserRepositoryAliasesRaw(requestParameters: GetUserRepositoryAliasesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<FindUnassignedUserRepositoryAliases200Response>> {
        if (requestParameters.name === null || requestParameters.name === undefined) {
     ...
     * Retrieve a page of aliases. The authenticated user must have restricted administrative permission or higher to use this resource.
     */
    async getUserRepositoryAliases(requestParameters: GetUserRepositoryAliasesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<FindUnassignedUserRepositoryAliases200Response> {
