...
export class ResourceApi extends runtime.BaseAPI {
     ...
     */
    async getUserTokensRaw(requestParameters: GetUserTokensRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<GetUserAccessTokens200Response>> {
        const queryParameters: any = {};
     ...
     * Retrieve a page of user\'s access tokens.
     */
    async getUserTokens(requestParameters: GetUserTokensRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<GetUserAccessTokens200Response> {
