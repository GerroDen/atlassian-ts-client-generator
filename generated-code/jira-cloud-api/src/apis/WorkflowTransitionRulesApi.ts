...
export class WorkflowTransitionRulesApi extends runtime.BaseAPI {
    ...
    /**
     * Creates request options for deleteWorkflowTransitionRuleConfigurations without sending the request
     */
    async deleteWorkflowTransitionRuleConfigurationsRequestOpts(requestParameters: DeleteWorkflowTransitionRuleConfigurationsRequest): Promise<runtime.RequestOpts> {
        ...
        let urlPath = `/rest/api/3/workflow/rule/config/delete`;
    ...
    async deleteWorkflowTransitionRuleConfigurationsRaw(requestParameters: DeleteWorkflowTransitionRuleConfigurationsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<WorkflowTransitionRulesUpdateErrors>> {
        const requestOptions = await this.deleteWorkflowTransitionRuleConfigurationsRequestOpts(requestParameters);
    ...
    /**
     * Creates request options for getWorkflowTransitionRuleConfigurations without sending the request
     */
    async getWorkflowTransitionRuleConfigurationsRequestOpts(requestParameters: GetWorkflowTransitionRuleConfigurationsRequest): Promise<runtime.RequestOpts> {
        ...
        let urlPath = `/rest/api/3/workflow/rule/config`;
    ...
    async getWorkflowTransitionRuleConfigurationsRaw(requestParameters: GetWorkflowTransitionRuleConfigurationsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<PageBeanWorkflowTransitionRules>> {
        const requestOptions = await this.getWorkflowTransitionRuleConfigurationsRequestOpts(requestParameters);
        const response = await this.request(requestOptions, initOverrides);
    ...
    /**
     * Creates request options for updateWorkflowTransitionRuleConfigurations without sending the request
     */
    async updateWorkflowTransitionRuleConfigurationsRequestOpts(requestParameters: UpdateWorkflowTransitionRuleConfigurationsRequest): Promise<runtime.RequestOpts> {
    ...
    async updateWorkflowTransitionRuleConfigurationsRaw(requestParameters: UpdateWorkflowTransitionRuleConfigurationsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<WorkflowTransitionRulesUpdateErrors>> {
        const requestOptions = await this.updateWorkflowTransitionRuleConfigurationsRequestOpts(requestParameters);
        const response = await this.request(requestOptions, initOverrides);
