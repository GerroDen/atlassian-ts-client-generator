...
export class PermissionSchemesApi extends runtime.BaseAPI {
    ...
    async createPermissionGrantRaw(requestParameters: CreatePermissionGrantRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<PermissionGrant>> {
        ...
        if (requestParameters.permissionGrant === null || requestParameters.permissionGrant === undefined) {
            throw new runtime.RequiredError('permissionGrant','Required parameter requestParameters.permissionGrant was null or undefined when calling createPermissionGrant.');
        }
