...
export interface AssignIssueRequest {
    issueIdOrKey: string;
    user: Omit<User, 'accountType'|'active'|'appType'|'applicationRoles'|'avatarUrls'|'displayName'|'emailAddress'|'expand'|'groups'|'guest'|'locale'|'self'|'timeZone'>;
}
...
export class IssuesApi extends runtime.BaseAPI {
    ...
    async archiveIssuesRequestOpts(requestParameters: ArchiveIssuesRequest): Promise<runtime.RequestOpts> {
        ...
        let urlPath = `/rest/api/3/issue/archive`;
    ...
    /**
     * Creates request options for archiveIssuesAsync without sending the request
     */
    async archiveIssuesAsyncRequestOpts(requestParameters: ArchiveIssuesAsyncRequest): Promise<runtime.RequestOpts> {
    ...
    async archiveIssuesAsyncRaw(requestParameters: ArchiveIssuesAsyncRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<string>> {
        const requestOptions = await this.archiveIssuesAsyncRequestOpts(requestParameters);
        const response = await this.request(requestOptions, initOverrides);
    ...
    /**
     * Creates request options for assignIssue without sending the request
     */
    async assignIssueRequestOpts(requestParameters: AssignIssueRequest): Promise<runtime.RequestOpts> {
        ...
        let urlPath = `/rest/api/3/issue/{issueIdOrKey}/assignee`;
    ...
    async assignIssueRaw(requestParameters: AssignIssueRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<any>> {
        const requestOptions = await this.assignIssueRequestOpts(requestParameters);
        const response = await this.request(requestOptions, initOverrides);
    ...
    /**
     * Creates request options for bulkFetchIssues without sending the request
     */
    async bulkFetchIssuesRequestOpts(requestParameters: BulkFetchIssuesRequest): Promise<runtime.RequestOpts> {
        ...
        let urlPath = `/rest/api/3/issue/bulkfetch`;
    ...
    async bulkFetchIssuesRaw(requestParameters: BulkFetchIssuesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<BulkIssueResults>> {
        const requestOptions = await this.bulkFetchIssuesRequestOpts(requestParameters);
        const response = await this.request(requestOptions, initOverrides);
    ...
    async createIssuesRequestOpts(requestParameters: CreateIssuesRequest): Promise<runtime.RequestOpts> {
        ...
        let urlPath = `/rest/api/3/issue/bulk`;
    ...
    async deleteIssueRequestOpts(requestParameters: DeleteIssueRequest): Promise<runtime.RequestOpts> {
        ...
        let urlPath = `/rest/api/3/issue/{issueIdOrKey}`;
        urlPath = urlPath.replace(`{${"issueIdOrKey"}}`, encodeURIComponent(String(requestParameters['issueIdOrKey'])));
    ...
    async doTransitionRequestOpts(requestParameters: DoTransitionRequest): Promise<runtime.RequestOpts> {
        ...
        let urlPath = `/rest/api/3/issue/{issueIdOrKey}/transitions`;
        urlPath = urlPath.replace(`{${"issueIdOrKey"}}`, encodeURIComponent(String(requestParameters['issueIdOrKey'])));
    ...
    /**
     * Creates request options for exportArchivedIssues without sending the request
     */
    async exportArchivedIssuesRequestOpts(requestParameters: ExportArchivedIssuesRequest): Promise<runtime.RequestOpts> {
        ...
        let urlPath = `/rest/api/3/issues/archive/export`;
    ...
    async exportArchivedIssuesRaw(requestParameters: ExportArchivedIssuesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ExportArchivedIssuesTaskProgressResponse>> {
        const requestOptions = await this.exportArchivedIssuesRequestOpts(requestParameters);
        const response = await this.request(requestOptions, initOverrides);
    ...
    /**
     * Creates request options for getBulkChangelogs without sending the request
     */
    async getBulkChangelogsRequestOpts(requestParameters: GetBulkChangelogsRequest): Promise<runtime.RequestOpts> {
        ...
        let urlPath = `/rest/api/3/changelog/bulkfetch`;
    ...
    async getBulkChangelogsRaw(requestParameters: GetBulkChangelogsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<BulkChangelogResponseBean>> {
        const requestOptions = await this.getBulkChangelogsRequestOpts(requestParameters);
        const response = await this.request(requestOptions, initOverrides);
    ...
    /**
     * Creates request options for getChangeLogs without sending the request
     */
    async getChangeLogsRequestOpts(requestParameters: GetChangeLogsRequest): Promise<runtime.RequestOpts> {
        if (requestParameters['issueIdOrKey'] == null) {
            throw new runtime.RequiredError(
                'issueIdOrKey',
        ...
        let urlPath = `/rest/api/3/issue/{issueIdOrKey}/changelog`;
        urlPath = urlPath.replace(`{${"issueIdOrKey"}}`, encodeURIComponent(String(requestParameters['issueIdOrKey'])));
    ...
    async getChangeLogsRaw(requestParameters: GetChangeLogsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<PageBeanChangelog>> {
        const requestOptions = await this.getChangeLogsRequestOpts(requestParameters);
        const response = await this.request(requestOptions, initOverrides);
    ...
    /**
     * Creates request options for getChangeLogsByIds without sending the request
     */
    async getChangeLogsByIdsRequestOpts(requestParameters: GetChangeLogsByIdsRequest): Promise<runtime.RequestOpts> {
        if (requestParameters['issueIdOrKey'] == null) {
            throw new runtime.RequiredError(
                'issueIdOrKey',
        ...
        let urlPath = `/rest/api/3/issue/{issueIdOrKey}/changelog/list`;
        urlPath = urlPath.replace(`{${"issueIdOrKey"}}`, encodeURIComponent(String(requestParameters['issueIdOrKey'])));
    ...
    async getChangeLogsByIdsRaw(requestParameters: GetChangeLogsByIdsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<PageOfChangelogs>> {
        const requestOptions = await this.getChangeLogsByIdsRequestOpts(requestParameters);
        const response = await this.request(requestOptions, initOverrides);
    ...
    /**
     * Creates request options for getCreateIssueMeta without sending the request
     * @deprecated
     */
    async getCreateIssueMetaRequestOpts(requestParameters: GetCreateIssueMetaRequest): Promise<runtime.RequestOpts> {
        const queryParameters: any = {};
        ...
        let urlPath = `/rest/api/3/issue/createmeta`;
    ...
    async getCreateIssueMetaRaw(requestParameters: GetCreateIssueMetaRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<IssueCreateMetadata>> {
        const requestOptions = await this.getCreateIssueMetaRequestOpts(requestParameters);
        const response = await this.request(requestOptions, initOverrides);
    ...
    /**
     * Creates request options for getCreateIssueMetaIssueTypeId without sending the request
     */
    async getCreateIssueMetaIssueTypeIdRequestOpts(requestParameters: GetCreateIssueMetaIssueTypeIdRequest): Promise<runtime.RequestOpts> {
        ...
        let urlPath = `/rest/api/3/issue/createmeta/{projectIdOrKey}/issuetypes/{issueTypeId}`;
    ...
    async getCreateIssueMetaIssueTypeIdRaw(requestParameters: GetCreateIssueMetaIssueTypeIdRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<PageOfCreateMetaIssueTypeWithField>> {
        const requestOptions = await this.getCreateIssueMetaIssueTypeIdRequestOpts(requestParameters);
        const response = await this.request(requestOptions, initOverrides);
    ...
    /**
     * Creates request options for getCreateIssueMetaIssueTypes without sending the request
     */
    async getCreateIssueMetaIssueTypesRequestOpts(requestParameters: GetCreateIssueMetaIssueTypesRequest): Promise<runtime.RequestOpts> {
        if (requestParameters['projectIdOrKey'] == null) {
            throw new runtime.RequiredError(
                'projectIdOrKey',
        ...
        let urlPath = `/rest/api/3/issue/createmeta/{projectIdOrKey}/issuetypes`;
        urlPath = urlPath.replace(`{${"projectIdOrKey"}}`, encodeURIComponent(String(requestParameters['projectIdOrKey'])));
    ...
    async getCreateIssueMetaIssueTypesRaw(requestParameters: GetCreateIssueMetaIssueTypesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<PageOfCreateMetaIssueTypes>> {
        const requestOptions = await this.getCreateIssueMetaIssueTypesRequestOpts(requestParameters);
        const response = await this.request(requestOptions, initOverrides);
    ...
    async getEditIssueMetaRequestOpts(requestParameters: GetEditIssueMetaRequest): Promise<runtime.RequestOpts> {
        ...
        let urlPath = `/rest/api/3/issue/{issueIdOrKey}/editmeta`;
        urlPath = urlPath.replace(`{${"issueIdOrKey"}}`, encodeURIComponent(String(requestParameters['issueIdOrKey'])));
     ...
     */
    async getEventsRequestOpts(): Promise<runtime.RequestOpts> {
        const queryParameters: any = {};
    ...
    async getEventsRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Array<IssueEvent>>> {
        const requestOptions = await this.getEventsRequestOpts();
        const response = await this.request(requestOptions, initOverrides);
    ...
    /**
     * Creates request options for getIssueLimitReport without sending the request
     */
    async getIssueLimitReportRequestOpts(requestParameters: GetIssueLimitReportRequest): Promise<runtime.RequestOpts> {
        const queryParameters: any = {};
        ...
        let urlPath = `/rest/api/3/issue/limit/report`;
    ...
    async getIssueLimitReportRaw(requestParameters: GetIssueLimitReportRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<IssueLimitReportResponseBean>> {
        const requestOptions = await this.getIssueLimitReportRequestOpts(requestParameters);
        const response = await this.request(requestOptions, initOverrides);
    ...
    async notifyRequestOpts(requestParameters: NotifyRequest): Promise<runtime.RequestOpts> {
        ...
        let urlPath = `/rest/api/3/issue/{issueIdOrKey}/notify`;
        urlPath = urlPath.replace(`{${"issueIdOrKey"}}`, encodeURIComponent(String(requestParameters['issueIdOrKey'])));
    ...
    /**
     * Creates request options for unarchiveIssues without sending the request
     */
    async unarchiveIssuesRequestOpts(requestParameters: UnarchiveIssuesRequest): Promise<runtime.RequestOpts> {
        if (requestParameters['issueArchivalSyncRequest'] == null) {
            throw new runtime.RequiredError(
                'issueArchivalSyncRequest',
        ...
        let urlPath = `/rest/api/3/issue/unarchive`;
    ...
    async unarchiveIssuesRaw(requestParameters: UnarchiveIssuesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<IssueArchivalSyncResponse>> {
        const requestOptions = await this.unarchiveIssuesRequestOpts(requestParameters);
        const response = await this.request(requestOptions, initOverrides);
