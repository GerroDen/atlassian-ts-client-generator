...
export class AvatarsApi extends runtime.BaseAPI {
     ...
     * Load avatar
     */
    async storeAvatarRaw(requestParameters: StoreAvatarOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Avatar>> {
        if (requestParameters.type === null || requestParameters.type === undefined) {
        ...
        if (requestParameters.storeAvatarRequest === null || requestParameters.storeAvatarRequest === undefined) {
            throw new runtime.RequiredError('storeAvatarRequest','Required parameter requestParameters.storeAvatarRequest was null or undefined when calling storeAvatar.');
        }
     ...
     * Load avatar
     */
    async storeAvatar(requestParameters: StoreAvatarOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Avatar> {
 ...
 * @export
 */
export const StoreAvatarOperationTypeEnum = {
    Project: 'project',
    Issuetype: 'issuetype'
} as const;
export type StoreAvatarOperationTypeEnum = typeof StoreAvatarOperationTypeEnum[keyof typeof StoreAvatarOperationTypeEnum];
