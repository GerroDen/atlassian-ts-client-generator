...
export class JiraExpressionsApi extends runtime.BaseAPI {
    ...
    /**
     * Creates request options for analyseExpression without sending the request
     */
    async analyseExpressionRequestOpts(requestParameters: AnalyseExpressionRequest): Promise<runtime.RequestOpts> {
        ...
        let urlPath = `/rest/api/3/expression/analyse`;
    ...
    async analyseExpressionRaw(requestParameters: AnalyseExpressionRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<JiraExpressionsAnalysis>> {
        const requestOptions = await this.analyseExpressionRequestOpts(requestParameters);
    ...
    /**
     * Creates request options for evaluateJSISJiraExpression without sending the request
     */
    async evaluateJSISJiraExpressionRequestOpts(requestParameters: EvaluateJSISJiraExpressionRequest): Promise<runtime.RequestOpts> {
        ...
        let urlPath = `/rest/api/3/expression/evaluate`;
    ...
    async evaluateJSISJiraExpressionRaw(requestParameters: EvaluateJSISJiraExpressionRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<JExpEvaluateJiraExpressionResultBean>> {
        const requestOptions = await this.evaluateJSISJiraExpressionRequestOpts(requestParameters);
        const response = await this.request(requestOptions, initOverrides);
    ...
    /**
     * Creates request options for evaluateJiraExpression without sending the request
     * @deprecated
     */
    async evaluateJiraExpressionRequestOpts(requestParameters: EvaluateJiraExpressionRequest): Promise<runtime.RequestOpts> {
        ...
        let urlPath = `/rest/api/3/expression/eval`;
    ...
    async evaluateJiraExpressionRaw(requestParameters: EvaluateJiraExpressionRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<JiraExpressionResult>> {
        const requestOptions = await this.evaluateJiraExpressionRequestOpts(requestParameters);
        const response = await this.request(requestOptions, initOverrides);
