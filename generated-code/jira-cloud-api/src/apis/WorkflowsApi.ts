...
export interface ListWorkflowHistoryRequest {
    workflowHistoryListRequest: WorkflowHistoryListRequest;
    expand?: string;
}

export interface ReadWorkflowFromHistoryRequest {
    workflowHistoryReadRequest: WorkflowHistoryReadRequest;
}
...
export class WorkflowsApi extends runtime.BaseAPI {
     ...
     * @deprecated
     */
    async createWorkflowRequestOpts(requestParameters: CreateWorkflowRequest): Promise<runtime.RequestOpts> {
        if (requestParameters['createWorkflowDetails'] == null) {
            throw new runtime.RequiredError(
                'createWorkflowDetails',
                'Required parameter "createWorkflowDetails" was null or undefined when calling createWorkflow().'
            );
        }
        ...
        let urlPath = `/rest/api/3/workflow`;
    ...
    /**
     * Creates request options for createWorkflows without sending the request
     */
    async createWorkflowsRequestOpts(requestParameters: CreateWorkflowsRequest): Promise<runtime.RequestOpts> {
        if (requestParameters['workflowCreateRequest'] == null) {
            throw new runtime.RequiredError(
                'workflowCreateRequest',
                'Required parameter "workflowCreateRequest" was null or undefined when calling createWorkflows().'
            );
        }
        ...
        let urlPath = `/rest/api/3/workflows/create`;
    ...
    async createWorkflowsRaw(requestParameters: CreateWorkflowsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<WorkflowCreateResponse>> {
        const requestOptions = await this.createWorkflowsRequestOpts(requestParameters);
        const response = await this.request(requestOptions, initOverrides);
    ...
    /**
     * Creates request options for deleteInactiveWorkflow without sending the request
     */
    async deleteInactiveWorkflowRequestOpts(requestParameters: DeleteInactiveWorkflowRequest): Promise<runtime.RequestOpts> {
        if (requestParameters['entityId'] == null) {
            throw new runtime.RequiredError(
                'entityId',
                'Required parameter "entityId" was null or undefined when calling deleteInactiveWorkflow().'
            );
        }
        ...
        let urlPath = `/rest/api/3/workflow/{entityId}`;
    ...
    async deleteInactiveWorkflowRaw(requestParameters: DeleteInactiveWorkflowRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        const requestOptions = await this.deleteInactiveWorkflowRequestOpts(requestParameters);
        const response = await this.request(requestOptions, initOverrides);
    ...
    /**
     * Creates request options for getDefaultEditor without sending the request
     */
    async getDefaultEditorRequestOpts(): Promise<runtime.RequestOpts> {
        const queryParameters: any = {};
        ...
        let urlPath = `/rest/api/3/workflows/defaultEditor`;
    ...
    async getDefaultEditorRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<DefaultWorkflowEditorResponse>> {
        const requestOptions = await this.getDefaultEditorRequestOpts();
        const response = await this.request(requestOptions, initOverrides);
    ...
    /**
     * Creates request options for getProjectUsagesForWorkflow without sending the request
     */
    async getProjectUsagesForWorkflowRequestOpts(requestParameters: GetProjectUsagesForWorkflowRequest): Promise<runtime.RequestOpts> {
        if (requestParameters['workflowId'] == null) {
            throw new runtime.RequiredError(
                'workflowId',
                'Required parameter "workflowId" was null or undefined when calling getProjectUsagesForWorkflow().'
            );
        }
        ...
        let urlPath = `/rest/api/3/workflow/{workflowId}/projectUsages`;
    ...
    async getProjectUsagesForWorkflowRaw(requestParameters: GetProjectUsagesForWorkflowRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<WorkflowProjectUsageDTO>> {
        const requestOptions = await this.getProjectUsagesForWorkflowRequestOpts(requestParameters);
        const response = await this.request(requestOptions, initOverrides);
    ...
    /**
     * Creates request options for getWorkflowProjectIssueTypeUsages without sending the request
     */
    async getWorkflowProjectIssueTypeUsagesRequestOpts(requestParameters: GetWorkflowProjectIssueTypeUsagesRequest): Promise<runtime.RequestOpts> {
        if (requestParameters['workflowId'] == null) {
            throw new runtime.RequiredError(
                'workflowId',
                'Required parameter "workflowId" was null or undefined when calling getWorkflowProjectIssueTypeUsages().'
            );
        }
        ...
        if (requestParameters['projectId'] == null) {
            throw new runtime.RequiredError(
                'projectId',
                'Required parameter "projectId" was null or undefined when calling getWorkflowProjectIssueTypeUsages().'
            );
        }
        ...
        let urlPath = `/rest/api/3/workflow/{workflowId}/project/{projectId}/issueTypeUsages`;
        urlPath = urlPath.replace(`{${"workflowId"}}`, encodeURIComponent(String(requestParameters['workflowId'])));
    ...
    async getWorkflowProjectIssueTypeUsagesRaw(requestParameters: GetWorkflowProjectIssueTypeUsagesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<WorkflowProjectIssueTypeUsageDTO>> {
        const requestOptions = await this.getWorkflowProjectIssueTypeUsagesRequestOpts(requestParameters);
        const response = await this.request(requestOptions, initOverrides);
    ...
    /**
     * Creates request options for getWorkflowSchemeUsagesForWorkflow without sending the request
     */
    async getWorkflowSchemeUsagesForWorkflowRequestOpts(requestParameters: GetWorkflowSchemeUsagesForWorkflowRequest): Promise<runtime.RequestOpts> {
        if (requestParameters['workflowId'] == null) {
            throw new runtime.RequiredError(
                'workflowId',
                'Required parameter "workflowId" was null or undefined when calling getWorkflowSchemeUsagesForWorkflow().'
            );
        }
        ...
        let urlPath = `/rest/api/3/workflow/{workflowId}/workflowSchemes`;
        urlPath = urlPath.replace(`{${"workflowId"}}`, encodeURIComponent(String(requestParameters['workflowId'])));
    ...
    async getWorkflowSchemeUsagesForWorkflowRaw(requestParameters: GetWorkflowSchemeUsagesForWorkflowRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<WorkflowSchemeUsageDTO>> {
        const requestOptions = await this.getWorkflowSchemeUsagesForWorkflowRequestOpts(requestParameters);
        const response = await this.request(requestOptions, initOverrides);
    ...
    /**
     * Creates request options for getWorkflowsPaginated without sending the request
     * @deprecated
     */
    async getWorkflowsPaginatedRequestOpts(requestParameters: GetWorkflowsPaginatedRequest): Promise<runtime.RequestOpts> {
        const queryParameters: any = {};
        ...
        let urlPath = `/rest/api/3/workflow/search`;
    ...
    async getWorkflowsPaginatedRaw(requestParameters: GetWorkflowsPaginatedRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<PageBeanWorkflow>> {
        const requestOptions = await this.getWorkflowsPaginatedRequestOpts(requestParameters);
        const response = await this.request(requestOptions, initOverrides);
    ...
    /**
     * Creates request options for listWorkflowHistory without sending the request
     */
    async listWorkflowHistoryRequestOpts(requestParameters: ListWorkflowHistoryRequest): Promise<runtime.RequestOpts> {
        if (requestParameters['workflowHistoryListRequest'] == null) {
            throw new runtime.RequiredError(
                'workflowHistoryListRequest',
                'Required parameter "workflowHistoryListRequest" was null or undefined when calling listWorkflowHistory().'
            );
        }
        ...
        let urlPath = `/rest/api/3/workflow/history/list`;
        ...
        return {
            ...
            headers: headerParameters,
            query: queryParameters,
            body: requestParameters['workflowHistoryListRequest'],
        };
    }
     ...
     */
    async listWorkflowHistoryRaw(requestParameters: ListWorkflowHistoryRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<WorkflowHistoryListResponseDTO>> {
        const requestOptions = await this.listWorkflowHistoryRequestOpts(requestParameters);
        const response = await this.request(requestOptions, initOverrides);
     ...
     * List workflow history entries
     */
    async listWorkflowHistory(requestParameters: ListWorkflowHistoryRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<WorkflowHistoryListResponseDTO> {
        const response = await this.listWorkflowHistoryRaw(requestParameters, initOverrides);
        return await response.value();
    }

    /**
     * Creates request options for readWorkflowFromHistory without sending the request
     */
    async readWorkflowFromHistoryRequestOpts(requestParameters: ReadWorkflowFromHistoryRequest): Promise<runtime.RequestOpts> {
        if (requestParameters['workflowHistoryReadRequest'] == null) {
            throw new runtime.RequiredError(
                'workflowHistoryReadRequest',
                'Required parameter "workflowHistoryReadRequest" was null or undefined when calling readWorkflowFromHistory().'
            );
        }
        ...
        let urlPath = `/rest/api/3/workflow/history`;
        ...
        return {
            ...
            headers: headerParameters,
            query: queryParameters,
            body: requestParameters['workflowHistoryReadRequest'],
        };
    }
     ...
     */
    async readWorkflowFromHistoryRaw(requestParameters: ReadWorkflowFromHistoryRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<WorkflowHistoryReadResponseDTO>> {
        const requestOptions = await this.readWorkflowFromHistoryRequestOpts(requestParameters);
        const response = await this.request(requestOptions, initOverrides);
     ...
     * Read workflow version from history
     */
    async readWorkflowFromHistory(requestParameters: ReadWorkflowFromHistoryRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<WorkflowHistoryReadResponseDTO> {
        const response = await this.readWorkflowFromHistoryRaw(requestParameters, initOverrides);
        return await response.value();
    }

    /**
     * Creates request options for readWorkflowPreviews without sending the request
     */
    async readWorkflowPreviewsRequestOpts(requestParameters: ReadWorkflowPreviewsRequest): Promise<runtime.RequestOpts> {
        if (requestParameters['workflowPreviewRequest'] == null) {
            throw new runtime.RequiredError(
                'workflowPreviewRequest',
                'Required parameter "workflowPreviewRequest" was null or undefined when calling readWorkflowPreviews().'
            );
        }
        ...
        let urlPath = `/rest/api/3/workflows/preview`;
    ...
    async readWorkflowPreviewsRaw(requestParameters: ReadWorkflowPreviewsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<WorkflowPreviewResponse>> {
        const requestOptions = await this.readWorkflowPreviewsRequestOpts(requestParameters);
        const response = await this.request(requestOptions, initOverrides);
    ...
    /**
     * Creates request options for readWorkflows without sending the request
     */
    async readWorkflowsRequestOpts(requestParameters: ReadWorkflowsRequest): Promise<runtime.RequestOpts> {
        if (requestParameters['workflowReadRequest'] == null) {
            throw new runtime.RequiredError(
                'workflowReadRequest',
                'Required parameter "workflowReadRequest" was null or undefined when calling readWorkflows().'
            );
        }
        ...
        let urlPath = `/rest/api/3/workflows`;
    ...
    async readWorkflowsRaw(requestParameters: ReadWorkflowsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<WorkflowReadResponse>> {
        const requestOptions = await this.readWorkflowsRequestOpts(requestParameters);
        const response = await this.request(requestOptions, initOverrides);
    ...
    /**
     * Creates request options for searchWorkflows without sending the request
     */
    async searchWorkflowsRequestOpts(requestParameters: SearchWorkflowsRequest): Promise<runtime.RequestOpts> {
        const queryParameters: any = {};
        ...
        let urlPath = `/rest/api/3/workflows/search`;
    ...
    async searchWorkflowsRaw(requestParameters: SearchWorkflowsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<WorkflowSearchResponse>> {
        const requestOptions = await this.searchWorkflowsRequestOpts(requestParameters);
        const response = await this.request(requestOptions, initOverrides);
    ...
    /**
     * Creates request options for updateWorkflows without sending the request
     */
    async updateWorkflowsRequestOpts(requestParameters: UpdateWorkflowsRequest): Promise<runtime.RequestOpts> {
        if (requestParameters['workflowUpdateRequest'] == null) {
            throw new runtime.RequiredError(
                'workflowUpdateRequest',
                'Required parameter "workflowUpdateRequest" was null or undefined when calling updateWorkflows().'
            );
        }
        ...
        let urlPath = `/rest/api/3/workflows/update`;
    ...
    async updateWorkflowsRaw(requestParameters: UpdateWorkflowsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<WorkflowUpdateResponse>> {
        const requestOptions = await this.updateWorkflowsRequestOpts(requestParameters);
        const response = await this.request(requestOptions, initOverrides);
    ...
    /**
     * Creates request options for validateCreateWorkflows without sending the request
     */
    async validateCreateWorkflowsRequestOpts(requestParameters: ValidateCreateWorkflowsRequest): Promise<runtime.RequestOpts> {
        if (requestParameters['workflowCreateValidateRequest'] == null) {
            throw new runtime.RequiredError(
                'workflowCreateValidateRequest',
                'Required parameter "workflowCreateValidateRequest" was null or undefined when calling validateCreateWorkflows().'
            );
        }
        ...
        let urlPath = `/rest/api/3/workflows/create/validation`;
    ...
    async validateCreateWorkflowsRaw(requestParameters: ValidateCreateWorkflowsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<WorkflowValidationErrorList>> {
        const requestOptions = await this.validateCreateWorkflowsRequestOpts(requestParameters);
        const response = await this.request(requestOptions, initOverrides);
    ...
    /**
     * Creates request options for validateUpdateWorkflows without sending the request
     */
    async validateUpdateWorkflowsRequestOpts(requestParameters: ValidateUpdateWorkflowsRequest): Promise<runtime.RequestOpts> {
        if (requestParameters['workflowUpdateValidateRequestBean'] == null) {
            throw new runtime.RequiredError(
                'workflowUpdateValidateRequestBean',
                'Required parameter "workflowUpdateValidateRequestBean" was null or undefined when calling validateUpdateWorkflows().'
            );
        }
        ...
        let urlPath = `/rest/api/3/workflows/update/validation`;
    ...
    async validateUpdateWorkflowsRaw(requestParameters: ValidateUpdateWorkflowsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<WorkflowValidationErrorList>> {
        const requestOptions = await this.validateUpdateWorkflowsRequestOpts(requestParameters);
        const response = await this.request(requestOptions, initOverrides);
    ...
    /**
     * Creates request options for workflowCapabilities without sending the request
     */
    async workflowCapabilitiesRequestOpts(requestParameters: WorkflowCapabilitiesRequest): Promise<runtime.RequestOpts> {
        const queryParameters: any = {};
        ...
        let urlPath = `/rest/api/3/workflows/capabilities`;
    ...
    async workflowCapabilitiesRaw(requestParameters: WorkflowCapabilitiesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<WorkflowCapabilities>> {
        const requestOptions = await this.workflowCapabilitiesRequestOpts(requestParameters);
        const response = await this.request(requestOptions, initOverrides);
