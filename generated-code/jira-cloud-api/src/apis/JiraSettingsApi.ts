...
export class JiraSettingsApi extends runtime.BaseAPI {
    ...
    async getAdvancedSettingsRequestOpts(): Promise<runtime.RequestOpts> {
        ...
        let urlPath = `/rest/api/3/application-properties/advanced-settings`;
    ...
    /**
     * Creates request options for getApplicationProperty without sending the request
     */
    async getApplicationPropertyRequestOpts(requestParameters: GetApplicationPropertyRequest): Promise<runtime.RequestOpts> {
        const queryParameters: any = {};
        ...
        let urlPath = `/rest/api/3/application-properties`;
    ...
    async getApplicationPropertyRaw(requestParameters: GetApplicationPropertyRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Array<ApplicationProperty>>> {
        const requestOptions = await this.getApplicationPropertyRequestOpts(requestParameters);
        const response = await this.request(requestOptions, initOverrides);
    ...
    async getConfigurationRequestOpts(): Promise<runtime.RequestOpts> {
        ...
        let urlPath = `/rest/api/3/configuration`;
    ...
    /**
     * Creates request options for setApplicationProperty without sending the request
     */
    async setApplicationPropertyRequestOpts(requestParameters: SetApplicationPropertyRequest): Promise<runtime.RequestOpts> {
        ...
        let urlPath = `/rest/api/3/application-properties/{id}`;
    ...
    async setApplicationPropertyRaw(requestParameters: SetApplicationPropertyRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ApplicationProperty>> {
        const requestOptions = await this.setApplicationPropertyRequestOpts(requestParameters);
        const response = await this.request(requestOptions, initOverrides);
