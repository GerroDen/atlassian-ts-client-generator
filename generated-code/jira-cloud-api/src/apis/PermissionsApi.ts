...
export class PermissionsApi extends runtime.BaseAPI {
    ...
    async getAllPermissionsRequestOpts(): Promise<runtime.RequestOpts> {
        ...
        let urlPath = `/rest/api/3/permissions`;
    ...
    /**
     * Creates request options for getBulkPermissions without sending the request
     */
    async getBulkPermissionsRequestOpts(requestParameters: GetBulkPermissionsRequest): Promise<runtime.RequestOpts> {
        ...
        let urlPath = `/rest/api/3/permissions/check`;
    ...
    async getBulkPermissionsRaw(requestParameters: GetBulkPermissionsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<BulkPermissionGrants>> {
        const requestOptions = await this.getBulkPermissionsRequestOpts(requestParameters);
        const response = await this.request(requestOptions, initOverrides);
    ...
    async getMyPermissionsRequestOpts(requestParameters: GetMyPermissionsRequest): Promise<runtime.RequestOpts> {
        ...
        let urlPath = `/rest/api/3/mypermissions`;
    ...
    /**
     * Creates request options for getPermittedProjects without sending the request
     */
    async getPermittedProjectsRequestOpts(requestParameters: GetPermittedProjectsRequest): Promise<runtime.RequestOpts> {
        ...
        let urlPath = `/rest/api/3/permissions/project`;
    ...
    async getPermittedProjectsRaw(requestParameters: GetPermittedProjectsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<PermittedProjects>> {
        const requestOptions = await this.getPermittedProjectsRequestOpts(requestParameters);
        const response = await this.request(requestOptions, initOverrides);
