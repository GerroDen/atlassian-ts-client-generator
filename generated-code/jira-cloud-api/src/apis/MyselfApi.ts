...
export class MyselfApi extends runtime.BaseAPI {
    ...
    /**
     * Creates request options for getLocale without sending the request
     */
    async getLocaleRequestOpts(): Promise<runtime.RequestOpts> {
        const queryParameters: any = {};
        ...
        let urlPath = `/rest/api/3/mypreferences/locale`;
    ...
    async getLocaleRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Locale>> {
        const requestOptions = await this.getLocaleRequestOpts();
        const response = await this.request(requestOptions, initOverrides);
    ...
    async getPreferenceRequestOpts(requestParameters: GetPreferenceRequest): Promise<runtime.RequestOpts> {
        ...
        let urlPath = `/rest/api/3/mypreferences`;
    ...
    /**
     * Creates request options for setLocale without sending the request
     * @deprecated
     */
    async setLocaleRequestOpts(requestParameters: SetLocaleRequest): Promise<runtime.RequestOpts> {
    ...
    async setLocaleRaw(requestParameters: SetLocaleRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<any>> {
        const requestOptions = await this.setLocaleRequestOpts(requestParameters);
        const response = await this.request(requestOptions, initOverrides);
