...
export const GetFiltersPaginatedOrderByEnum = {
    ...
    FavouriteCountDescDesc: '-favourite_count',
    FavouriteCountAscAsc: '+favourite_count',
    Id: 'id',
    IdDescDesc: '-id',
    IdAscAsc: '+id',
    IsFavourite: 'is_favourite',
    IsFavouriteDescDesc: '-is_favourite',
    IsFavouriteAscAsc: '+is_favourite',
    Name: 'name',
    NameDescDesc: '-name',
    NameAscAsc: '+name',
    Owner: 'owner',
    ...
    OwnerAscAsc: '+owner',
    IsShared: 'is_shared',
    IsSharedDescDesc: '-is_shared',
    IsSharedAscAsc: '+is_shared'
} as const;
