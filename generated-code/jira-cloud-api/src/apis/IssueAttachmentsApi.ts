...
export class IssueAttachmentsApi extends runtime.BaseAPI {
     ...
     */
    async getAttachmentContentRaw(requestParameters: GetAttachmentContentRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<object>> {
        if (requestParameters.id === null || requestParameters.id === undefined) {
     ...
     * Get attachment content
     */
    async getAttachmentContent(requestParameters: GetAttachmentContentRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<object> {
     ...
     */
    async getAttachmentThumbnailRaw(requestParameters: GetAttachmentThumbnailRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<object>> {
        if (requestParameters.id === null || requestParameters.id === undefined) {
     ...
     * Get attachment thumbnail
     */
    async getAttachmentThumbnail(requestParameters: GetAttachmentThumbnailRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<object> {
