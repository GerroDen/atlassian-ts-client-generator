...
export class IssueAttachmentsApi extends runtime.BaseAPI {
    ...
    async addAttachmentRequestOpts(requestParameters: AddAttachmentRequest): Promise<runtime.RequestOpts> {
        ...
        let urlPath = `/rest/api/3/issue/{issueIdOrKey}/attachments`;
    ...
    /**
     * Creates request options for expandAttachmentForHumans without sending the request
     */
    async expandAttachmentForHumansRequestOpts(requestParameters: ExpandAttachmentForHumansRequest): Promise<runtime.RequestOpts> {
        ...
        let urlPath = `/rest/api/3/attachment/{id}/expand/human`;
    ...
    async expandAttachmentForHumansRaw(requestParameters: ExpandAttachmentForHumansRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<AttachmentArchiveMetadataReadable>> {
        const requestOptions = await this.expandAttachmentForHumansRequestOpts(requestParameters);
        const response = await this.request(requestOptions, initOverrides);
    ...
    /**
     * Creates request options for expandAttachmentForMachines without sending the request
     */
    async expandAttachmentForMachinesRequestOpts(requestParameters: ExpandAttachmentForMachinesRequest): Promise<runtime.RequestOpts> {
        if (requestParameters['id'] == null) {
            throw new runtime.RequiredError(
                'id',
        ...
        let urlPath = `/rest/api/3/attachment/{id}/expand/raw`;
        urlPath = urlPath.replace(`{${"id"}}`, encodeURIComponent(String(requestParameters['id'])));
    ...
    async expandAttachmentForMachinesRaw(requestParameters: ExpandAttachmentForMachinesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<AttachmentArchiveImpl>> {
        const requestOptions = await this.expandAttachmentForMachinesRequestOpts(requestParameters);
        const response = await this.request(requestOptions, initOverrides);
    ...
    async getAttachmentRequestOpts(requestParameters: GetAttachmentRequest): Promise<runtime.RequestOpts> {
        ...
        let urlPath = `/rest/api/3/attachment/{id}`;
        urlPath = urlPath.replace(`{${"id"}}`, encodeURIComponent(String(requestParameters['id'])));
    ...
    async getAttachmentContentRequestOpts(requestParameters: GetAttachmentContentRequest): Promise<runtime.RequestOpts> {
        ...
        let urlPath = `/rest/api/3/attachment/content/{id}`;
        urlPath = urlPath.replace(`{${"id"}}`, encodeURIComponent(String(requestParameters['id'])));
    ...
    async getAttachmentMetaRequestOpts(): Promise<runtime.RequestOpts> {
        ...
        let urlPath = `/rest/api/3/attachment/meta`;
    ...
    async getAttachmentThumbnailRequestOpts(requestParameters: GetAttachmentThumbnailRequest): Promise<runtime.RequestOpts> {
        ...
        let urlPath = `/rest/api/3/attachment/thumbnail/{id}`;
        urlPath = urlPath.replace(`{${"id"}}`, encodeURIComponent(String(requestParameters['id'])));
