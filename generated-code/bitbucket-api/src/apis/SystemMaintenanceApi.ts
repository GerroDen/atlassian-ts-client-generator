...
export class SystemMaintenanceApi extends runtime.BaseAPI {
     ...
     */
    async create1Raw(requestParameters: Create1Request, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<RestHookScript>> {
        const queryParameters: any = {};
     ...
     * Create a new hook script
     */
    async create1(requestParameters: Create1Request = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<RestHookScript> {
     ...
     * Get license details
     */
    async get4Raw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<RestBitbucketLicense>> {
        const queryParameters: any = {};
     ...
     * Get license details
     */
    async get4(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<RestBitbucketLicense> {
        const response = await this.get4Raw(initOverrides);
        return await response.value();
    }
     ...
     */
    async getAllRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<RestMeshNode>> {
        const queryParameters: any = {};
     ...
     * Get all registered Mesh nodes
     */
    async getAll(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<RestMeshNode> {
     ...
     * Get rate limit settings for user
     */
    async getAll1(requestParameters: GetAll1Request = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<GetAll1200Response> {
     ...
     * Get a hook script
     */
    async getById(requestParameters: GetByIdRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<RestHookScript> {
     ...
     * Get Mesh node
     */
    async getById1(requestParameters: GetById1Request, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<RestMeshNode> {
     ...
     */
    async registerRaw(requestParameters: RegisterRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<RestMeshNode>> {
        const queryParameters: any = {};
     ...
     * Register new Mesh node
     */
    async register(requestParameters: RegisterRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<RestMeshNode> {
     ...
     * Update a hook script
     */
    async update(requestParameters: UpdateRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<RestHookScript> {
     ...
     * Update license
     */
    async update1Raw(requestParameters: Update1Request, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<RestBitbucketLicense>> {
        const queryParameters: any = {};
     ...
     * Update license
     */
    async update1(requestParameters: Update1Request = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<RestBitbucketLicense> {
     ...
     * Update Mesh node
     */
    async update2(requestParameters: Update2Request, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<RestMeshNode> {
